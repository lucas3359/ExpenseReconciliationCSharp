...
namespace ExpenseReconciliation.Migrations
{
    ...
    [Migration("20221209093909_CreateAuditTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExpenseReconciliation.Domain.Models.Audit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("ExpenseReconciliation.Domain.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<decimal?>("DefaultSplit")
                        .HasColumnType("numeric")
                        .HasColumnName("default_split");
                    ...
                    b.Property<bool?>("SplitIncluded")
                        .HasColumnType("boolean")
                        .HasColumnName("split_included");
            ...
            modelBuilder.Entity("ExpenseReconciliation.Domain.Models.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("ExpenseReconciliation.Domain.Models.Audit", b =>
                {
                    b.HasOne("ExpenseReconciliation.Domain.Models.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_audit_user_user_id");
            ...
            modelBuilder.Entity("ExpenseReconciliation.Domain.Models.Transaction", b =>
                {
                    b.HasOne("ExpenseReconciliation.Domain.Models.Category", "Category")
                        .WithMany("Transactions")
                        .HasForeignKey("CategoryId")
                        .HasConstraintName("fk_transaction_categories_category_id");
